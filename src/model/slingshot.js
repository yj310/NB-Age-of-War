class Slingshot {
  ...
  fire(targetX, targetY) {
    ...
    // 마우스를 당긴 방향 계산 (새총에서 마우스로)
    const pullDx = targetX - this.x;
    const pullDy = targetY - this.y;
    ...
    const targetX_final = this.x + cos(fireAngle) * farDistance;
    const targetY_final = this.y + sin(fireAngle) * farDistance;
